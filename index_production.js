...
let privateKey = fs.readFileSync( '/etc/letsencrypt/live/sassayer.com/privkey.pem' )
let certificate = fs.readFileSync( '/etc/letsencrypt/live/sassayer.com/fullchain.pem' )
